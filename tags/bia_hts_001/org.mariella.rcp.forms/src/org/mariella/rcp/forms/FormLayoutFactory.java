...
public static FormLayout createFormLayout() {
	...
	formLayout.marginBottom  = FORM_BODY_MARGIN_BOTTOM;
	formLayout.marginLeft = FORM_BODY_MARGIN_LEFT;
	formLayout.marginRight = FORM_BODY_MARGIN_RIGHT;
	formLayout.marginTop = FORM_BODY_MARGIN_TOP;
	formLayout.marginHeight = FORM_BODY_MARGIN_HEIGHT;
	formLayout.marginWidth = FORM_BODY_MARGIN_WIDTH;
