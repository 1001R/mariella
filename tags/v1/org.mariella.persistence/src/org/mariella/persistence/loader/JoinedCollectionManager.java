...
public class JoinedCollectionManager {
	private final Map<Object, Map<CollectionPropertyDescription, Collection<Object>>> joinedCollections = new HashMap<Object, Map<CollectionPropertyDescription, Collection<Object>>>();
...
public void newObject(ClusterDescription clusterDescription, String pathExpression, ClassDescription effectiveClassDescription, Object object) {
	...
	if(map == null) {
		map = new HashMap<CollectionPropertyDescription, Collection<Object>>();
		joinedCollections.put(object, map);
	}
	for(String childExpression : clusterDescription.getChildPathExpressions(pathExpression)) {
		...
		if(pd != null && pd instanceof CollectionPropertyDescription && !map.containsKey(pd)) {
			map.put((CollectionPropertyDescription)pd, new HashSet<Object>());
		}
	}
}
...
private void finish(Object object, CollectionPropertyDescription pd, Collection<Object> added) {
	List value = (List)ModifiableAccessor.Singleton.getValue(object, pd);
