...
public PersonEditorSection(VResourceFormPage page, Composite parent) {
...
private void addFirstName(Composite parent) {
	...
	Activator.getBindingFactory().createTextBinding(getCustomEditingContext().getBindingContext(), 
			...
			Activator.getBindingFactory().copyExtend(DomainSymbols.FirstName,
					new SelectionManagementExtension("firstName")
					),
...
private void addLastName(Composite parent) {
	...
	Activator.getBindingFactory().createTextBinding(getCustomEditingContext().getBindingContext(), 
			...
			Activator.getBindingFactory().copyExtend(DomainSymbols.LastName,
					new SelectionManagementExtension("lastName")
					),	
			new TextBindingDetails(SWT.Modify));
}
