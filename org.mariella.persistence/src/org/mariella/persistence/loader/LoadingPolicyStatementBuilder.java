...
public static class NamespaceProvider implements QueryBuilderNamespaceProvider {
	...
	private IQueryBuilderNamespace nsGlobal = new QueryBuilderNamespace();
	private IQueryBuilderNamespace nsQuery = new QueryBuilderNamespace();
	private IQueryBuilderNamespace nsConditions = new QueryBuilderNamespace();
...
private class ConditionProviderHandler implements QueryBuilderListener {
	private final ClusterLoaderConditionProvider conditionProvider;
	private boolean processing = false;
	private final Set<TableReference> visitedTableReferences = new HashSet<TableReference>();
...
public LoadingPolicyStatementBuilder(LoadingPolicy loadingPolicy, LoaderContext loaderContext, ClusterLoaderConditionProvider conditionProvider) {
	super();
